...
<html>
  <head>
	...
	<style>
	   body{
		...
		.header .component-header .container .header-items .active1,.active2{
		    position: relative;
  ...
  <body>
        ...
        <div class="component-header">
                <div class="container">
                    ...
                    <div class="header-items">
                        ...
                        <div class="active2">${user.userName}</div>
                    </div>
                </div>
            </div>
    ...
    <div style="width: 1000px;margin:50px auto 20;border:1px solid gainsboro;" ></div>
    <div style="font-size: 13px;margin-left:258px; margin-bottom: 30px; color: rgb(102, 102, 102);"><a href="${pageContext.request.contextPath}/servlet/FontEndServlet" style="text-decoration: none;padding-top: 2px;color: rgb(102, 102, 102);display: inline-block; ">首页</a>>图书归还</div>
    <h2 style="font-size: 20px; font-weight: 500;margin: 0 auto 50px;width: 1000px; text-align: center;">—&nbsp;&nbsp;&nbsp;图书归还&nbsp;&nbsp;&nbsp;—</h2>
    <div class="history">
        <div class="history-content">
            <div class="content-title">未还图书</div>
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody class="table-tbody">
                	<c:forEach items="${allBRM2}" var="vbrm">
                		<form action="${pageContext.request.contextPath}/servlet/FontEndServlet?method=returnBook" method="post">
		                    <tr>
		                        <td><input type="hidden" value="${user.userId}" name="userid">${vbrm.bookName}</td>
		                        <td>借出</td>
		                        <td>${vbrm.borrDate}</td>
		                        <td>${vbrm.latestretDate}</td>
		                        <td><input type="hidden" value="${vbrm.barCode}" name="barcode">${vbrm.barCode}</td>
